...
async function seed() {
  ...
  const usersData = [
    ...
    {
      email: "abul.laskar@mederp.com",
      passwordHash: doctorHash,
      firstName: "Abul Basar",
      lastName: "Laskar",
      ...
      doctorProfile: {
        ...
        opdRoom: "OPD-1",
        regNo: "WBMC 84217",
        prescriptionCredentials: "M.B.B.S. (Kolkata)",
        prescriptionDescription: "Ex-House Physician, Burdwan Medical College & General Physician",
        prescriptionTags: ["General Medicine", "Primary Care", "Adult Health"],
        bio: "General physician providing approachable, comprehensive primary care for adults and families.",
        qualifications: [{ qualification: "M.B.B.S.", institution: "Kolkata" }],
        experience: [{ role: "Ex-House Physician", organization: "Burdwan Medical College" }],
      },
    },
    {
      email: "debasish.basak@mederp.com",
      passwordHash: doctorHash,
      firstName: "Debasish",
      lastName: "Basak",
      role: "doctor" as const,
      ...
      doctorProfile: {
        ...
        opdRoom: "OPD-2",
        regNo: "47874",
        prescriptionCredentials: "General Physician",
        prescriptionDescription: "Trained in Cardiology",
        prescriptionTags: ["General Medicine", "Heart Care", "Preventive Cardiology"],
        bio: "General physician trained in cardiology, supporting routine medical care and heart-health follow-up.",
        qualifications: [{ qualification: "General Physician", institution: "Cardiology Training" }],
        experience: [{ role: "General Physician", organization: "Clinical Practice" }],
      },
    },
    {
      email: "nishant.chandra@mederp.com",
      passwordHash: doctorHash,
      firstName: "Nishant",
      lastName: "Chandra",
      role: "doctor" as const,
      branchId: brn01.id,
      doctorProfile: {
        specialty: "General Medicine, Cardio-Diabetic & Child Care",
        consultationFee: 500,
        opdRoom: "OPD-3",
        phone: "+91 90731 39601",
        prescriptionCredentials: "M.B.B.S., General Physician",
        prescriptionDescription: "Cardio-Diabetic & Child Care; Medical Officer, Mirik BPHC",
        prescriptionTags: ["Cardiology", "Diabetic Care", "Child Health", "General Medicine"],
        bio: "General physician with practice interests in cardiology, diabetic care, and child health.",
        qualifications: [{ qualification: "M.B.B.S.", institution: "Medical Education" }],
        experience: [
          { role: "Medical Officer", organization: "Mirik B.P.H.C." },
          { role: "Ex-House Staff, Medicine", organization: "NBMCH" },
        ],
      },
    },
    {
      email: "nayeem.ali@mederp.com",
      passwordHash: doctorHash,
      firstName: "Md Nayeem",
      lastName: "Ali",
      role: "doctor" as const,
      branchId: brn01.id,
      doctorProfile: {
        specialty: "Orthopaedics, Joint Replacement & Trauma Surgery",
        consultationFee: 700,
        opdRoom: "OPD-4",
        regNo: "WB-85775",
        phone: "+91 73844 57427, +91 97759 31980",
        prescriptionCredentials: "M.B.B.S., M.S. Orthopaedics",
        prescriptionDescription: "Consultant Joint Replacement & Trauma Surgeon",
        prescriptionTags: ["Joint Replacement", "Trauma Surgery", "Sports Injury", "Paediatric Orthopaedics", "Spine Surgery"],
        bio: "Orthopaedic surgeon focused on joint replacement, trauma care, sports injuries, and comprehensive bone and joint treatment.",
        qualifications: [
          { qualification: "M.B.B.S.", institution: "Medical Education" },
          { qualification: "M.S. Orthopaedics", institution: "Orthopaedic Surgery" },
          { qualification: "Fellowship in Arthroplasty", institution: "Advanced Orthopaedics" },
          { qualification: "Fellowship in Sports Injury", institution: "Advanced Orthopaedics" },
        ],
        experience: [
          { role: "Consultant Joint Replacement & Trauma Surgeon", organization: "Medineuro Healthcare Center, Siliguri" },
          { role: "Consultant Orthopaedic Surgeon", organization: "Artemisia Surgery Clinic, Paramount Hospital, Siliguri" },
        ],
      },
    },
    {
      email: "richard.narjinary@mederp.com",
      passwordHash: doctorHash,
      firstName: "Richard",
      lastName: "Narjinary",
      role: "doctor" as const,
      ...
      doctorProfile: {
        ...
        regNo: "WBMC-60053",
        phone: "94341-37999",
        prescriptionCredentials: "M.B.B.S., D.L.O.",
        prescriptionDescription: "ENT & Head and Neck Surgeon",
        prescriptionTags: ["ENT Care", "Head & Neck Surgery", "Hearing Care", "Sinus Care"],
        bio: "ENT and head-and-neck surgeon providing care for ear, nose, throat, and related head-and-neck conditions.",
        qualifications: [
          { qualification: "M.B.B.S.", institution: "Medical Education" },
          { qualification: "D.L.O.", institution: "ENT" },
        ],
        experience: [{ role: "ENT & Head and Neck Surgeon", organization: "Clinical Practice" }],
      },
    },
  ];
